...
class JsonReaderTest extends JsonTest {
    ...
    void testReadEmptySystem() {
        JsonReader testReader = new JsonReader("ProjectStarter/data/testEmptySystemReader.json");
        try {
            RentalSystem testSystem = testReader.read();
    ...
    void testReadExampleSystem() {
        ...
        try {
            ...
            testVehicle = new Vehicle(0, "Bus", 20, "Osborne");
            testVehicle.rent("Julia");
            testVehicle.returnVehicle();
            testVehicle.rent("Mark");
            testVehicle.returnVehicle();
            expectedVehicles.add(testVehicle);
            
            testVehicle = new Vehicle(2, "Bike", 5, "Osborne");
            testVehicle.rent("Sam");
            expectedVehicles.add(testVehicle);
